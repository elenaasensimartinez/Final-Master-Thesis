...
OUT="/scratch_isilon/groups/compgen/easensi/Captive_TFM/Geno_likelihood/"; mkdir -p $OUT #path to saving folder
...
ref="/scratch/devel/malvarest/refs/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna" #path to reference genome
                        ...
                        ### obtention of a beagle file per chromosome with all samples ###
