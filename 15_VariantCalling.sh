...
vcf="/scratch_isilon/groups/compgen/easensi/Captive_TFM/MergeGVCFs"
vcf_out="/scratch_isilon/groups/compgen/easensi/Captive_TFM/Variant_Calling"; mkdir -p $vcf_out
