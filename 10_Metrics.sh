...
bam_merged="/scratch_isilon/groups/compgen/easensi/Captive_TFM/MergedBam" #merged BAM files
bam_rmdups="/scratch_isilon/groups/compgen/easensi/Captive_TFM/RemoveDuplicates" #removed duplicates BAM files
bam_filtered="/scratch_isilon/groups/compgen/easensi/Captive_TFM/Filter" #filtered by insert size BAM files
ref="/scratch/devel/malvarest/refs/GRCh38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna" #reference genome

                                                        ### metrics for the three samples ###
