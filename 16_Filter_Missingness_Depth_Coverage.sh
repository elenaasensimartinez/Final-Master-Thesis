...
vcf="/scratch_isilon/groups/compgen/easensi/Captive_TFM/Variant_Calling_def107" #path to VCFs
vcf_indels="/scratch_isilon/groups/compgen/easensi/Captive_TFM/vcf_filter_miss_depth" #path to saving file
...
bcftools filter -e 'F_MISSING > 0.2' ${vcf}/${samples}_variantcall_def107.vcf.gz | vcftools --gzvcf - --minDP 6 --maxDP 36 --minGQ 30 --recode --stdout | bcftools filter -e \"TYPE!='indels'\" -o ${vcf_indels}/${samples}_filter_miss_depth.vcf.gz
